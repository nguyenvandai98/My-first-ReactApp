                  ...
                  <div className="recent-blog">
                    <a href="#" className="rb-item">
                      <div className="rb-pic">
                        <img src={require("../../../assets/img/blog/recent-1.jpg")} alt="" />
                      </div>
                    ...
                    <a href="#" className="rb-item">
                      <div className="rb-pic">
                        <img src={require("../../../assets/img/blog/recent-2.jpg")} alt="" />
                      </div>
                      <div className="rb-text">
                        <h6>The Personality Trait That Makes...</h6>
                        <p>Fashion <span>- May 19, 2019</span></p>
                    ...
                    <a href="#" className="rb-item">
                      <div className="rb-pic">
                        <img src={require("../../../assets/img/blog/recent-3.jpg")} alt="" />
                      </div>
                      <div className="rb-text">
                        <h6>The Personality Trait That Makes...</h6>
                        <p>Fashion <span>- May 19, 2019</span></p>
                    ...
                    <a href="#" className="rb-item">
                      <div className="rb-pic">
                        <img src={require("../../../assets/img/blog/recent-4.jpg")} alt="" />
                      </div>
                      <div className="rb-text">
                        <h6>The Personality Trait That Makes...</h6>
                        <p>Fashion <span>- May 19, 2019</span></p>
