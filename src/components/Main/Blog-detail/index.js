            ...
            <div className="col-lg-12">
              <div className="blog-details-inner">
                ...
                <div className="blog-large-pic">
                  <img src={require("../../../assets/img/blog/blog-detail.jpg")} alt="" />
                </div>
                ...
                <div className="blog-more">
                  <div className="row">
                    <div className="col-sm-4">
                      <img src={require("../../../assets/img/blog/blog-detail-1.jpg")} alt="" />
                    </div>
                    <div className="col-sm-4">
                      <img src={require("../../../assets/img/blog/blog-detail-2.jpg")} alt="" />
                    </div>
                    <div className="col-sm-4">
                      <img src={require("../../../assets/img/blog/blog-detail-3.jpg")} alt="" />
                    </div>
                  </div>
                </div>
                    ...
                    <div className="col-lg-5 offset-lg-2 col-md-6">
                      <a href="#" className="next-blog">
                        <div className="nb-pic">
                          <img src={require("../../../assets/img/blog/next-blog.png")} alt="" />
                ...
                <div className="posted-by">
                  <div className="pb-pic">
                    <img src={require("../../../assets/img/blog/post-by.png")} alt="" />
                  </div>
                  <div className="pb-text">
                    <a href="#">
                      <h5>Shane Lynch</h5>
